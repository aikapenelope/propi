...
RUN apt-get update && apt-get install -y --no-install-recommends openssl=1.1.1n-0+deb11u5 ca-certificates=20210119~deb11u3 curl=7.74.0-1.3+deb11u6 && rm -rf /var/lib/apt/lists/*
