    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://clerk.propi.aikalabs.cc https://*.clerk.accounts.dev https://code.iconify.design https://cdn.tailwindcss.com https://cdnjs.cloudflare.com",
